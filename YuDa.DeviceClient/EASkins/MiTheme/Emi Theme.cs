...
namespace EASkins
{
    ...
    [DefaultEvent("TextChanged")]
    public class Emi_TextBox_Small : UserControl
    {
        #region Variables
        ...
        public Emi_TextBox_Small()
        {
            ...
            P1 = new Pen(Color.FromArgb(118, 118, 118)); // P1 = Border color
            B1 = new SolidBrush(Color.DarkSlateGray); // B1 = Rect Background color
            BackColor = Color.Transparent;
            ForeColor = Color.DimGray;
