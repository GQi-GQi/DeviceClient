...
namespace EASkins.Controls
{
    public class MaterialForm : Form, IMaterialControl
    {
        ...
        private const int WMSZ_TOPLEFT = 6;
        ...
        private const int ACTION_BAR_HEIGHT = 24;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            {
                int iconSize = new List<int>() { Icon.Width, Icon.Height, ACTION_BAR_HEIGHT }.Min();
                g.DrawImage(Icon.ToBitmap(), new Rectangle(WMSZ_TOPLEFT, 0, iconSize, iconSize));
            }

            //Form title
            g.DrawString(Text, Font, SkinManager.ColorScheme.TextBrush,
                new Rectangle(WMSZ_TOPLEFT + (ShowIcon ? Icon.Width : 0), 0, Width, ACTION_BAR_HEIGHT), new StringFormat { LineAlignment = StringAlignment.Center });
        }
    }
