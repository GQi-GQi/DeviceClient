...
namespace YuDa.DeviceClient
{
    public class Common
    {
        ...
        const string TOKEN_MD5KEY = "FGHd1213ry32v68fHZ"; // 线上加密密钥
        //const string TOKEN_MD5KEY = "JUlSU8XCqswBiA4pztfvUIQuzomhKntk"; // 加密密钥
        ...
        public static string TokenEncodeMD5(string text) => MD5(text + TOKEN_MD5KEY);
        ...
        /// <returns></returns>
        public static bool IsCommPortValid(string port)
        {
            try
            {
        ...
        /// <summary>
        /// 去除字符串空格, tab字符, 换行符和新行
        /// </summary>
        /// <param name="str"></param>
        /// <returns></returns>
        public static string StrRegexTrim(string str)
        {
